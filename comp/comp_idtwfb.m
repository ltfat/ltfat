...
if do_complex
   ...
   c1 = cellfun(@(cEl1,cEl2) cEl1 + cEl2, c(1:end/2),c(end:-1:end/2+1),...
             'UniformOutput',0);
   c2 = cellfun(@(cEl1,cEl2) -1i*cEl1 + 1i*cEl2, c(1:end/2),c(end:-1:end/2+1),...
             'UniformOutput',0);
else
...
f2 = comp_iwfbt(c2,dualnodes,Lc,rangeLoc,rangeOut,ext); 
