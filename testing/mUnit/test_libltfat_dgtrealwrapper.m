...
for idx = 1:numel(Larr)
    ...
    params = calllib('libltfat','ltfat_dgtreal_params_allocdef');
    calllib('libltfat','ltfat_dgtreal_params_set_phaseconv',params,phaseconv.LTFAT_TIMEINV);
    calllib('libltfat','ltfat_dgtreal_params_set_hint',params,hintstruct.(hint));
    calllib('libltfat','ltfat_dgtreal_params_set_fftwflags',params,fftwflags.FFTW_MEASURE);
    ...
    calllib('libltfat','ltfat_dgtreal_params_free',params);
    ...
    calllib('libltfat','ltfat_dgtreal_params_set_phaseconv',params,phaseconv.LTFAT_TIMEINV);
    calllib('libltfat','ltfat_dgtreal_params_set_hint',params,hintstruct.(hint));
    calllib('libltfat','ltfat_dgtreal_params_set_fftwflags',params,fftwflags.FFTW_ESTIMATE);
