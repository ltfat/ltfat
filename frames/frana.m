...
switch(F.type)
 ...
 case 'ufilterbank'
  ...
  case 'nsdgt'
    outsig=framenative2coef(F,nsdgt(insig,F.g,F.a));
  case 'unsdgt'
    outsig=framenative2coef(F,unsdgt(insig,F.g,F.a));
  case 'nsdgtreal'
    outsig=framenative2coef(F,nsdgtreal(insig,F.g,F.a));
  case 'unsdgtreal'
    outsig=framenative2coef(F,unsdgtreal(insig,F.g,F.a));
