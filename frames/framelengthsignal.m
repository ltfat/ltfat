...
%   *F* is long enough to expand the signal. If the frame length is longer
%   than the signal length, the signal will be zero-padded by |framet|_.
%
%   If instead a set of coefficients *coef* are given, call |framelengthcoef|_.
%
