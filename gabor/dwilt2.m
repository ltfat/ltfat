...
%
%   DWILT2(f,g,M) calculates a two dimensional discrete
%   Wilson transform of the input signal f using the window g
%   and parameter M along each dimension.
%
...
%   f will be appropriatly zero-extended.
%
