...
%   window g on the lattice specified by the time shift _a and the number of
%   channels M. The algorithm used to perform this calculation computes
...
%
%   [tgrad,fgrad,c]=GABPHASEGRAD('dgt',f,g,a,M) additionally returns the Gabor
%   coefficients c, as they are always computed as a byproduct of the algorithm.
%
%   [tgrad,fgrad]=GABPHASEGRAD('phase',cphase,a) computes the phase gradient
%   from the phase cphase of a DGT of the signal. The original DGT from
%   which the phase is obtained must have been computed using a time-shift
%   of _a.
%
%   [tgrad,fgrad]=GABPHASEGRAD('abs',s,g,a) computes the phase gradient from
%   the spectrogram s. The spectrogram must have been computed using the
%   window g and time-shift _a.
%
