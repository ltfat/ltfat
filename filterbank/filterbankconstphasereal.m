...
for kk = 1:M
    ...
    tgrad(kk,:) = tgrad(kk,:)./tfr(kk)*cfreqdiff(kk);
end
...
newphase = 0;
usedmask = 0;
%[newphase, usedmask] = comp_filterbankconstphasereal(abss,tgrad,fgrad,a,M,tol,flags.do_timeinv,mask,usephase);

% Build the coefficients
c=0;%abss.*exp(1i*newphase);
