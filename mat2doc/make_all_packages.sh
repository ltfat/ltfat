...
mat2doc.py `pwd`/.. mat --script=release.py --zip --dos --addon=ltfat_win32oct --packagename=ltfat-%s-win32oct
mat2doc.py `pwd`/.. mat --script=release.py --zip --addon=ltfat_maci --packagename=ltfat-%s-maci
