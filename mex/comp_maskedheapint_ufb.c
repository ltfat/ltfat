...
// Calling convention:
//                              0 1     2     3     4    5 6   7         8
// phase=comp_maskedheapint_ufb(s,tgrad,fgrad,cfreq,mask,a,tol,phasetype,usephase);
                              ...
                              int UNUSED(nrhs), const mxArray* prhs[] )
{
    ...
    if (phasetype == 1)
        LTFAT_NAME(maskedheapint_ufb)(s, tgrad, fgrad, cfreq, mask,
                                  a, M, L, W, tol, phase);
    else
        LTFAT_NAME(maskedheapint_relgrad_ufb)(s, tgrad, fgrad, cfreq, mask,
                                          a, M, L, W, tol, phase);
