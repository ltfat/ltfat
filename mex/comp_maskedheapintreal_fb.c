...
// phase=comp_maskedheapintreal_fb(s,tgrad,fgrad,neigh,posInfo,cfreq, mask, a,M,N,tol,phasetype,usephase);
                              ...
                              int UNUSED(nrhs), const mxArray* prhs[] )
{
    ...
    if (phasetype == 1)
        LTFAT_NAME(maskedheapint_fb)(s, tgrad, fgrad, mask, neighPtr, posinfoPtr, cfreq,
                                     a, M, NPtr, Nsum, W, tol, phase);
    else
        LTFAT_NAME(maskedheapint_relgrad_fb)(s , tgrad, fgrad, mask, neighPtr,
